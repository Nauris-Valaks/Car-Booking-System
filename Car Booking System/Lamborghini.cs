...
// Version 1.0 15/05/2018
{
    public partial class Lamborghini : Form
    {
        ...
        private void Lamborghini_Load(object sender, EventArgs e)
        {
            ...
            {
                this.carsTableAdapter.FillLambo(this.projectDataSet.Cars); // Using the table cars from dataset to fill the Lamborghini combo box with Lamborghini models once the form loads
            }
