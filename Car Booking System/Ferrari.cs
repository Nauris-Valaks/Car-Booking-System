...
{
    public partial class Ferrari : Form
    {
        public Ferrari()
        {
            InitializeComponent();
        ...
        private void Ferrari_Load(object sender, EventArgs e)
        {
            ...
            this.customer_InfoTableAdapter1.Fill(this.dataSet1.Customer_Info);
            ...
            {
                this.carsTableAdapter.FillFerrari(this.projectDataSet.Cars); // Using the table cars from dataset to fill the Ferrari combo box with Ferrari models once the form loads
            }
        ...
        {
            this.Visible = false; // Closes the current form
            (new Aston()).Show(); // Shows the home form
        }
